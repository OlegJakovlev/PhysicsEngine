...
namespace CustomApplication
{
	void PlayGameScene::Init(const PhysicsEngine::PhysicsEngine* physicsEngine)
	{
		...
		auto metallicGrey = colorDatabase->AddEntry(CRC32_STR("OuterWall"), physx::PxVec3(0.23, 0.12, 0.629)).data;
		...
		physx::PxGeometry* cornerPole = geoFactory->CreateCapsule(physx::PxVec2(minHeightOffset, cornerPoleHeight / 2));
		...
		ballRenderData.SetColour(whiteColor);
		AddGameActor(ballGameObject);

		// Top Goal
		GameObject* topGoalPart = m_gameObjectFactory->CreateDynamicGameObject(physx::PxTransform(physx::PxVec3(0, goalHeight + goalRadius, 55)), GameObject::Layer::Layer_Default);
		shapeCreator->CreateShape(*topGoalPart->GetPhysicsActorPointer(), goalXWall, CRC32_STR("Aluminum"));
		AddGameActor(topGoalPart);

		GameObject* leftGoalPart = m_gameObjectFactory->CreateDynamicGameObject(physx::PxTransform(physx::PxVec3(-goalWidth / 2, goalHeight / 2 + goalRadius, 55), physx::PxQuat(physx::PxPi / 2, physx::PxVec3(0.0f, 0.0f, 1.0f))), GameObject::Layer::Layer_Default);
		shapeCreator->CreateShape(*leftGoalPart->GetPhysicsActorPointer(), goalYWall, CRC32_STR("Aluminum"));
		AddGameActor(leftGoalPart);

		GameObject* rightGoalPart = m_gameObjectFactory->CreateDynamicGameObject(physx::PxTransform(physx::PxVec3(goalWidth / 2, goalHeight / 2 + goalRadius, 55), physx::PxQuat(physx::PxPi / 2, physx::PxVec3(0.0f, 0.0f, 1.0f))), GameObject::Layer::Layer_Default);
		shapeCreator->CreateShape(*rightGoalPart->GetPhysicsActorPointer(), goalYWall, CRC32_STR("Aluminum"));
		AddGameActor(rightGoalPart);

		GameObject* leftBottomGoalPart = m_gameObjectFactory->CreateDynamicGameObject(physx::PxTransform(physx::PxVec3(-goalWidth / 2, goalRadius, 55), physx::PxQuat(physx::PxPi / 2, physx::PxVec3(0.0f, 1.0f, 0.0f))), GameObject::Layer::Layer_Default);
		...
		GameObject* rightBottomGoalPart = m_gameObjectFactory->CreateDynamicGameObject(physx::PxTransform(physx::PxVec3(goalWidth / 2, goalRadius, 55), physx::PxQuat(physx::PxPi / 2, physx::PxVec3(0.0f, 1.0f, 0.0f))), GameObject::Layer::Layer_Default);
		...
		// Gamefield walls
		GameFieldOuterWalls(shapeCreator, geoFactory, minHeightOffset);
		GameFieldMarking(shapeCreator, geoFactory, minHeightOffset);
	...
	void PlayGameScene::GameFieldOuterWalls(const PhysicsEngine::ShapeCreator* shapeCreator, const PhysicsEngine::GeometryFactory* geoFactory, float minHeightOffset)
	{
		float wallHeight = 1;
	...
	void PlayGameScene::GameFieldMarking(const PhysicsEngine::ShapeCreator* shapeCreator, const PhysicsEngine::GeometryFactory* geoFactory, float minHeightOffset)
	{
		...
		shapeCreator->CreateTrigger(*topInnerLineMarkingTrigger->GetPhysicsActorPointer(), innerFieldMarkingXTrigger, CRC32_STR("WetGrass"));
		...
		shapeCreator->CreateTrigger(*bottomInnerLineMarkingTrigger->GetPhysicsActorPointer(), innerFieldMarkingXTrigger, CRC32_STR("WetGrass"));
		...
		shapeCreator->CreateTrigger(*leftInnerLineMarkingTrigger->GetPhysicsActorPointer(), innerFieldMarkingZTrigger, CRC32_STR("WetGrass"));
		...
		shapeCreator->CreateTrigger(*rightInnerLineMarkingTrigger->GetPhysicsActorPointer(), innerFieldMarkingZTrigger, CRC32_STR("WetGrass"));
