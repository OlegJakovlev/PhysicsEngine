...
namespace PhysicsEngine
{
	...
	public:
		...
		Actor* CreateClothActor(physx::PxU32*& quads, const physx::PxTransform& transform, const physx::PxVec2& size = physx::PxVec2(1.f, 1.f), physx::PxU32 width = 1, physx::PxU32 height = 1);
	};
}
