...
#ifdef REMOTE_VISUAL_DEBUG
	if (!m_physics->Init(m_foundation->GetFoundationService(), m_visualDebuger->GetPVDService()))
#else
	if (!m_physics->Init(m_foundation->GetFoundationService(), nullptr))
#endif
	{
